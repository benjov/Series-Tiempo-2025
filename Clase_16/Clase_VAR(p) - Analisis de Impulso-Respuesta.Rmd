---
title: "Clase 16. VAR(p) - Analisis de Impulso-Respuesta"
...
DCETE28 <- ts(Datos_Ad$CETE28_Ad - lag(Datos_Ad$CETE28_Ad, 1), 
               start = c(2000, 1), 
               freq = 12)
...
Datos <- data.frame(cbind(DLINPC, DLTC, DCETE28, DLIGAE, DLIPI))
...
VAR_p <- VAR(Datos, p = 1, type = "const")
